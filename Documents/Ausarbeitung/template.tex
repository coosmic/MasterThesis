...
Die Pipeline Punktwolke generieren wird mit dem Anlegen einen neuen Zeitstempels gestartet. Es wird aus den hoch geladenen Bildern eine Punktwolke generiert.
...
Überführt die Punktwolke in das Shapenet-Format. Die Punktwolke muss in diesem Format vorliegen um die beiden Segmentierungs-Pipelines nutzen zu können.
...
Auch wird der Hintegrund entfernt und aus den verbleibenden Punkten, die nur noch Pflanzen-Punkte enthalten sollten wieder eine Punktwolke im Shapenet-Format erstellt.

\textbf{Segmentierung Pflanze}

Auf dem Ergebniss der Hintergrund-Entfernung wird PointNet++ zur Segmentierung der Pflanze gestartet. Auch hier wird das Ergebnis im Speicher des Host-Systems abgegelegt. Dieses wird aber nicht weiter bearbeitet.
