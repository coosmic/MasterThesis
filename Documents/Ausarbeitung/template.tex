...
RPM-Net baut auf RPM \cite{RPM} auf. RPM hat zu ICP den Unterschied das zwischen den beidne Punkwolken keine harten Zurodnungen gemacht werden. Statt dessen wird eine weiche Zurodnung vorgenommen die iterativ zu einer harten Zurodnung eingschränkt wird.
