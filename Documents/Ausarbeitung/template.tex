...
Hierbei wird die Archtiektur von RPM belassen, allerdings wird nach dem Rotation bekannt ist die Sklaierung, wie in den Gleichungen \ref{eq:icp_scale:1} - \ref{eq:icp_scale:2} beschrieben, berechenet.
Des weiteren muss die Berechnung der Translation angepasst werden. Für das Training des angepassten Netzes muss auch das Training überarbeitet werden. 
Diese Schritte wurde bereits ausgeführt, nur konnte das Training bisher nicht ausgewertet und mit den bisher genutzten Verfahren verglichen werden. 
