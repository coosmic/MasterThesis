...
Colmap stellt eine Pipeline bereit die eine inkrementelle Implementation von SfM implementiert. Initial wird nach korrespondierenden Bildern gesucht und diese dann inkrementell in die Rekonstruktion aufgenommen.
