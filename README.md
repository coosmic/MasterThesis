...
./pgm -J Shapenet --in ~/Thesis/MasterThesis/python/data/avocado/background/odm_filterpoints/point_cloud.ply --out ~/Thesis/MasterThesis/python/data/avocado/background/shapenet/point_cloud --RemoveBackground false --MaxSubsample 1
...
# Simple Waves
./pgm -J SurfaceGenerator --CalculateNormals true --SearchRadius 0.05 --PointCountX 200 --PointCountY 200 --NumberOfWaves 4.0 --WaveAmplitude 0.05 --out ~/Thesis/test/Generated/Background/SurfacceWaves1.ply

# Slope
./pgm -J SurfaceGenerator --CalculateNormals true --SearchRadius 0.05 --PointCountX 200 --PointCountY 200 --NumberOfWaves 4.0 --WaveAmplitude 0.0 --out ~/Thesis/test/Generated/Background/SurfaceSlope1.ply --JitterScale 2.0 --SlopeAmplitude 1.0 --Slope true

# Gaussian
./pgm -J SurfaceGenerator --CalculateNormals true --SearchRadius 0.05 --PointCountX 200 --PointCountY 200 --NumberOfWaves 4.0 --WaveAmplitude 0.0 --out ~/Thesis/test/Generated/Background/SurfaceGauss1.ply --JitterScale 2.0 --Sigma 200.0 --Gaussian true

# Combined
./pgm -J SurfaceGenerator --CalculateNormals true --SearchRadius 0.05 --PointCountX 200 --PointCountY 200 --NumberOfWaves 4.0 --WaveAmplitude 0.05 --out ~/Thesis/test/Generated/Background/SurfaceSlope25Gauss400Waves4.ply --JitterScale 2.0 --Sigma 400.0 --Gaussian true --Slope true  --SlopeAmplitude 0.25
```
...
### Plot Generation
``` shell
python reportPointNetpp.py --pathIn ~/Thesis/MasterThesis/python/pointnet2/part_seg/results/training/t13_2Classes_PartSeg_WithNorm_WithoutRot_WithoutNormals/log_train.txt --plotName T13_3C_PS_WN_NR_NN
python reportPointNetpp.py --pathIn ~/Thesis/MasterThesis/python/pointnet2/part_seg/results/training/t12_3Classes_PartSeg_WithNorm_NoRot_OnlyCenter/log_train.txt --plotName T12_3C_PS_WN_NR_OC
python reportPointNetpp.py --pathIn ~/Thesis/MasterThesis/python/pointnet2/part_seg/results/training/t11_2Classes_PartSeg_WithNorm_WithoutRot/log_train.txt --plotName T11_2C_PS_WN_NR
python reportPointNetpp.py --pathIn ~/Thesis/MasterThesis/python/pointnet2/part_seg/results/training/t10_2Classes_PartSeg_WitNorm_WithRotation/log_train.txt --plotName T10_2C_PS_WN_RR
python reportPointNetpp.py --pathIn ~/Thesis/MasterThesis/python/pointnet2/part_seg/results/training/t9_3Classes_PartSeg_WitNorm_WithRotation/log_train.txt --plotName T9_3C_PS_WN_RR
python reportPointNetpp.py --pathIn ~/Thesis/MasterThesis/python/pointnet2/part_seg/results/training/t8_2Classes_PartSeg_NoNorm_RandRot/log_train.txt --plotName T8_2C_PS_NN_RR
python reportPointNetpp.py --pathIn ~/Thesis/MasterThesis/python/pointnet2/part_seg/results/training/t7_3ClassesPartSegNoNorm/log_train.txt --plotName T7_3C_PS_NN_NR
python reportPointNetpp.py --pathIn ~/Thesis/MasterThesis/python/pointnet2/part_seg/results/training/t6_2ClassesPartSeg/log_train.txt --plotName T6_2C_PS_NN_NR
python reportPointNetpp.py --pathIn ~/Thesis/MasterThesis/python/pointnet2/part_seg/results/training/t5_3ClassesPartSeg3C/log_train.txt --plotName T5_3C_PS_WN_NR
python reportPointNetpp.py --pathIn ~/Thesis/MasterThesis/python/pointnet2/part_seg/results/training/t4_3ClassesPartSeg/log_train.txt --plotName T4_3C_PS_WN_NR
```