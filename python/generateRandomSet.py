...
parser.add_argument('--pathIn', default='/home/solomon/Thesis/python/data/plants/shapenet/withRotationWithoutBackground/', help='Path to Folder that contains Samples')
parser.add_argument('--pathOut', default='/home/solomon/Thesis/python/data/plants/shapenet/withRotationWithoutBackground/split/', help='Path to Folder that where Sets should be saved')
