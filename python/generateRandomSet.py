...
parser.add_argument('--pathIn', default='/home/solomon/Thesis/python/data/plants/shapenet/', help='Path to Folder that contains Samples')
parser.add_argument('--pathOut', default='/home/solomon/Thesis/python/data/plants/shapenet/split/', help='Path to Folder that where Sets should be saved')
